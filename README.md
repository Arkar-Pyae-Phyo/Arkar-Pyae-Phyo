...
<p align="center">
  <strong>Junior Cloud / ML Engineer</strong> · Cloud Engineering · DevOps · IaC · Kubernetes · ML Deployment
</p>
...
## Profile
International engineering student at **Mae Fah Luang University (Thailand)** focused on **cloud computing** and **machine learning**.  
Interested in building **secure, scalable systems** and applying **DevOps + IaC** practices to production-grade deployment workflows.

- Current focus: **Cloud Engineering** and **Infrastructure as Code (IaC)**
- Learning: **Advanced Kubernetes patterns** and **AWS serverless architectures**
...
## Achievements
- **Grand Prize Winner (National Round)** — Huawei ICT Competition (Cloud Track) *(2025–2026)*  
  Representative of Thailand
- **1st Runner-Up** — Code for Hope Hackathon *(Jun 26–27, 2025)* — Payap University (Chiang Mai)
- **Winner** — AR/VR Joint International Workshop & Competition (JIWC) *(2024)* — Mae Fah Luang University
- **2nd Runner-Up** — AI/GAME Joint International Workshop & Competition (JIWC) *(2025)* — Mae Fah Luang University
